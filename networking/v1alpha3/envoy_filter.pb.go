...
type EnvoyFilter struct {
	...
	// Determines where in the filter chain this `EnvoyFilter` is to be injected.
	WasmPhase v1alpha1.PluginPhase `protobuf:"varint,7,opt,name=wasm_phase,json=wasmPhase,proto3,enum=istio.extensions.v1alpha1.PluginPhase" json:"wasm_phase,omitempty"`
	// Determines ordering of `EnvoyFilter` in the same `wasm_phase`.
	// When multiple `EnvoyFilter` are applied to the same workload in the
	// same `wasm_phase`, they will be applied by priority, in descending order.
	// If `priority` is not set, or two `EnvoyFilter` exist with the same
	// value, the ordering will be deterministically derived from name and
	// namespace of the `EnvoyFilter`. Defaults to `0`.
	WasmPriority  int32 `protobuf:"varint,8,opt,name=wasm_priority,json=wasmPriority,proto3" json:"wasm_priority,omitempty"`
...
func (x *EnvoyFilter) GetWasmPhase() v1alpha1.PluginPhase {
	if x != nil {
		return x.WasmPhase
	}
	return v1alpha1.PluginPhase(0)
}

func (x *EnvoyFilter) GetWasmPriority() int32 {
	if x != nil {
		return x.WasmPriority
	}
	return 0
}
...
const file_networking_v1alpha3_envoy_filter_proto_rawDesc = "" +
	"\n" +
	"&networking/v1alpha3/envoy_filter.proto\x12\x19istio.networking.v1alpha3\x1a\x1cgoogle/protobuf/struct.proto\x1a!networking/v1alpha3/sidecar.proto\x1a\x1btype/v1beta1/selector.proto\x1a\x1eextensions/v1alpha1/wasm.proto\"\xf2\x1b\n" +
	"\vEnvoyFilter\x12X\n" +
	...
	"\bpriority\x18\x05 \x01(\x05R\bpriority\x12E\n" +
	"\n" +
	"wasm_phase\x18\a \x01(\x0e2&.istio.extensions.v1alpha1.PluginPhaseR\twasmPhase\x12#\n" +
	"\rwasm_priority\x18\b \x01(\x05R\fwasmPriority\x1a\xcb\x01\n" +
	"\n" +
	"ProxyMatch\x12#\n" +
...
var file_networking_v1alpha3_envoy_filter_proto_goTypes = []any{
	...
	(v1alpha1.PluginPhase)(0),                                    // 21: istio.extensions.v1alpha1.PluginPhase
...
var file_networking_v1alpha3_envoy_filter_proto_depIdxs = []int32{
	...
	21, // 3: istio.networking.v1alpha3.EnvoyFilter.wasm_phase:type_name -> istio.extensions.v1alpha1.PluginPhase
	13, // 4: istio.networking.v1alpha3.EnvoyFilter.ProxyMatch.metadata:type_name -> istio.networking.v1alpha3.EnvoyFilter.ProxyMatch.MetadataEntry
	15, // 5: istio.networking.v1alpha3.EnvoyFilter.RouteConfigurationMatch.vhost:type_name -> istio.networking.v1alpha3.EnvoyFilter.RouteConfigurationMatch.VirtualHostMatch
	16, // 6: istio.networking.v1alpha3.EnvoyFilter.ListenerMatch.filter_chain:type_name -> istio.networking.v1alpha3.EnvoyFilter.ListenerMatch.FilterChainMatch
	...
	14, // 19: istio.networking.v1alpha3.EnvoyFilter.RouteConfigurationMatch.VirtualHostMatch.route:type_name -> istio.networking.v1alpha3.EnvoyFilter.RouteConfigurationMatch.RouteMatch
	17, // 20: istio.networking.v1alpha3.EnvoyFilter.ListenerMatch.FilterChainMatch.filter:type_name -> istio.networking.v1alpha3.EnvoyFilter.ListenerMatch.FilterMatch
	18, // 21: istio.networking.v1alpha3.EnvoyFilter.ListenerMatch.FilterMatch.sub_filter:type_name -> istio.networking.v1alpha3.EnvoyFilter.ListenerMatch.SubFilterMatch
